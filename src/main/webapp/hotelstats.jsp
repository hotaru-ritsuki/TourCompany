    ...
    <div class="table-Hotel" style="overflow-x:auto;">
        <table>
            ...
            <tr>
                ...
                <th>Hotel</th>
                <th>Visitors</th>
                <th>AverageBookingTime</th>
                <c:forEach var="stats" items="${hotelstats}">
            <tr>
                <td><img src="${pageContext.request.contextPath}/images/${stats.hotelId}.png" alt="image" width="300"
                         height="300"></td>
                <td><a>${stats.hotelName}</a></td>
                <td>${stats.visitors}</td>
                <td>${stats.averageBookingTime} Days</td>
            </tr>
            </c:forEach>
            </tr>
